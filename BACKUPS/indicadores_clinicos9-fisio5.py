...
# --- FUNÇÃO 9: TAXA RE-IOT 48H (A NOVA) ---
def calculate_taxa_re_iot(df_clinico_raw, selected_month, selected_year):
    ...
    - Numerador: SOMA 're_iot_sim_nao' = '1'.
    - Denominador: SOMA 'eot_sim_nao' = '1' MENOS SOMA 'eot_acidental' = '1'.
    """
    ...
    coluna_eot_sim_nao = 'eot_sim_nao' 
    coluna_eot_acidental = 'eot_acidental' 
    coluna_re_iot = 're_iot_sim_nao' # O Numerador
    ...
    # Numerador: Total de Re-IOTs ('re_iot_sim_nao' = '1') que ocorreram no mês
    numerador = (df_eventos_mes[coluna_re_iot] == '1').sum()
    
    # Denominador: Total de EOTs Planejadas

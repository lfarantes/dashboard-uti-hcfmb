...
# --- FUNÇÃO 18: DENSIDADE INFECÇÃO ITU (A NOVA) ---
def calculate_densidade_infeccao_itu(df_clinico_raw, selected_month, selected_year):
    ...
    - Filtro: Mês Corrente.
    - Numerador: SOMA 'itu_numero' (do geral) onde 'infeccoes_durante_uti_data' está no mês.
    - Denominador (SVD-dias): SOMA 'uso_de_svd_nas_ultimas_24h' = '1' (do diário) onde 'data_diario' está no mês.

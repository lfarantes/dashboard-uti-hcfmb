...
# --- FUNÇÃO 6: TAXA UTILIZAÇÃO VM (A NOVA) ---
def calculate_taxa_utilizacao_vm(df_clinico_raw, selected_month, selected_year):
    ...
    - Numerador (VM-dias): SOMA 'suporte_vm_ultimas_24h' = '1'.
    ...
    # Numerador (VM-dias): Contagem de 'Sim' ('1') em suporte_vm_ultimas_24h
    numerador = (df_diario_mes[coluna_vm] == '1').sum()
    
    # Denominador (Paciente-dias): Contagem de 'Sim' ('1') em paciente_ocupando_leito

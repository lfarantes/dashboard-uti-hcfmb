...
# --- FUNÇÃO 17: DENSIDADE INFECÇÃO PAV (A NOVA) ---
def calculate_densidade_infeccao_pav(df_clinico_raw, selected_month, selected_year):
    ...
    - Filtro: Mês Corrente.
    - Numerador: SOMA 'pavm_numero' (do geral) onde 'infeccoes_durante_uti_data' está no mês.
    - Denominador (VM-dias): SOMA 'suporte_vm_ultimas_24h' = '1' (do diário) onde 'data_diario' está no mês.

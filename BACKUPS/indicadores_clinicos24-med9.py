...
# --- FUNÇÃO 24: TAXA DE RE-SOLICITAÇÃO 48H (A NOVA) ---
def calculate_taxa_resolicitacao_48h(df_clinico_raw, selected_month, selected_year):
    ...
    - Numerador: SOMA 're_solicitacao_do_leito' = '1'.
    ...
    coluna_data_desfecho = 'data_do_desfecho_uti'
    coluna_desfecho = 'desfecho_uti'
    coluna_resolicitacao = 're_solicitacao_do_leito' # <-- MUDANÇA AQUI
    ...
    # Numerador: Total de Re-solicitações ('1') NO MESMO PERÍODO

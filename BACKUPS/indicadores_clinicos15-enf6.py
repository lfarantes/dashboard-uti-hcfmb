...
# --- FUNÇÃO 15: TAXA INCIDÊNCIA FLEBITE (A NOVA) ---
def calculate_taxa_incidencia_flebite(df_clinico_raw, selected_month, selected_year):
    ...
    - Filtro: Mês Corrente (baseado na data do evento 'flebite_data').
    - Numerador: SOMA 'teve_flebite' = '1' NO MÊS.
    ...
    # Filtra os eventos de Flebite que ocorreram no mês/ano selecionados

...
# --- FUNÇÃO 8: TAXA EOT ACIDENTAL (A NOVA) ---
def calculate_taxa_eot_acidental(df_clinico_raw, selected_month, selected_year):
    ...
    - Numerador: SOMA 'eot_acidental' = '1'.
    ...
    coluna_data_eot = 'eot' 
    coluna_eot_sim_nao = 'eot_sim_nao' 
    coluna_eot_acidental = 'eot_acidental' # <-- A ÚNICA MUDANÇA
    ...
    # Numerador: Total de EOTs Acidentais ('eot_acidental' = '1') que ocorreram no mês

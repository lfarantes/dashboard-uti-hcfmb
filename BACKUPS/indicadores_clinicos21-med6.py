...
# --- FUNÇÃO 21: TEMPO MÉDIO DE PERMANÊNCIA (A NOVA) ---
def calculate_tempo_medio_permanencia(df_clinico_raw, selected_month, selected_year):
    ...
    - Filtro: Mês Corrente.
    - Numerador (Paciente-dias): SOMA 'paciente_ocupando_leito' = '1' (do diário) onde 'data_diario' está no mês.
    - Denominador (Nº Desfechos): CONTAGEM de desfechos ('desfecho_uti' não nulo) onde 'data_do_desfecho_uti' está no mês.
    ...
    # O denominador é qualquer desfecho (contagem de linhas filtradas pela data)

...
def calculate_saps3_media(df_clinico_raw, selected_month, selected_year):
    ...
    - Campos: 'saps_3_pontuacao', 'saps_3'
    - Fórmula: Média
    """
    ...
    # Converter colunas de SAPS-3 para numérico

...
# --- FUNÇÃO 22: TAXA DE MORTALIDADE HOSPITALAR (A NOVA) ---
def calculate_taxa_mortalidade_hospitalar(df_clinico_raw, selected_month, selected_year):
    ...
    - Filtro: Mês do DESFECHO HOSPITALAR (Mês Corrente).
    - Numerador: Nº de Óbitos Hospitalares ('2').
    - Denominador: Nº Total de Desfechos Hospitalares (Alta='1', Óbito='2', Transferência='3').
    """

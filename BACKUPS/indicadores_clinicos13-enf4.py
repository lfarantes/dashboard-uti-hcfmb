...
# --- FUNÇÃO 13: TAXA UTILIZAÇÃO DVA (A NOVA) ---
def calculate_taxa_utilizacao_dva(df_clinico_raw, selected_month, selected_year):
    ...
    - Numerador (DVA-dias): SOMA 'dva_nas_ultimas_24h' = '1'.
    ...
    coluna_data_diario = 'data_diario'
    coluna_dva = 'dva_nas_ultimas_24h' # <-- Numerador (MUDOU)
    ...
    # Numerador (DVA-dias): Contagem de 'Sim' ('1')

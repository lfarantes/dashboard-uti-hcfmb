...
# --- FUNÇÃO 10: TAXA UTILIZAÇÃO CVC (A NOVA) ---
def calculate_taxa_utilizacao_cvc(df_clinico_raw, selected_month, selected_year):
    ...
    - Numerador (CVC-dias): SOMA 'uso_cvc_nas_ultimas_24h' = '1'.
    ...
    coluna_data_diario = 'data_diario'
    coluna_cvc = 'uso_cvc_nas_ultimas_24h' # <-- Numerador
    coluna_leito = 'paciente_ocupando_leito' # <-- Denominador
    ...
    # Numerador (CVC-dias): Contagem de 'Sim' ('1')

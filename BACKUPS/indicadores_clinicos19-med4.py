...
# --- FUNÇÃO 19: DIÁRIAS EVITÁVEIS (A NOVA) ---
def calculate_diarias_evitaveis(df_clinico_raw, selected_month, selected_year):
    ...
    - Filtro: Mês Corrente (baseado na 'data_solicitacao_alta').
    - Numerador: SOMA (data_do_desfecho_uti - data_solicitacao_alta) para desfechos '1' (Alta) ou '3' (Transferência).
    ...
    # Filtra pelos eventos de solicitação de alta que ocorreram no mês
    ...
    # Filtra apenas por Alta ('1') ou Transferência ('3')
    ...
    # Garante que dias negativos (erro de preenchimento) não sejam contados

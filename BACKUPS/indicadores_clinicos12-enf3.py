...
# --- FUNÇÃO 12: TAXA UTILIZAÇÃO DIALISE (A NOVA) ---
def calculate_taxa_utilizacao_dialise(df_clinico_raw, selected_month, selected_year):
    ...
    - Numerador (Diálise-dias): SOMA 'di_lise_nas_ultimas_24h' = '1'.
    ...
    coluna_data_diario = 'data_diario'
    coluna_dialise = 'di_lise_nas_ultimas_24h' # <-- Numerador (MUDOU)
    ...
    # Numerador (Diálise-dias): Contagem de 'Sim' ('1')
